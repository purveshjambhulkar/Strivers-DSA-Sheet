...
- [Longest Subarray with Sum K](#1-longest-subarray-with-sum-k)
- [Largest Subarray with 0 Sum](#2-largest-subarray-with-0-sum)

---

### 📂 **Category 2 - Count Based**
- [Subarray Sum Equals K](#3-subarray-sum-equals-k)
- [Count Subarrays with Given XOR](#4-count-subarrays-with-given-xor)

---

### 📂 **Category 3 - Kadane's Algorithm Based**
- [Maximum Subarray](#5-maximum-subarray)
- [Maximum Product Subarray](#6-maximum-product-subarray)
---
