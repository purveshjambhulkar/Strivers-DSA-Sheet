...
- [Next Greater Element I](#-1-next-greater-element-i)
- [Next Greater Element II](#-2-next-greater-element-ii)
- [Next Smaller Element](#-3-next-smaller-element)
- [Count Of Greater Elements To The Right](#-4-count-of-greater-elements-to-the-right)

### Category: Histogram and Range-Based

- [Sum of Subarray Minimums](#-1-sum-of-subarray-minimums)
- [Sum of Subarray Ranges](#-2-sum-of-subarray-ranges)
- [Largest Rectangle in Histogram](#-3-largest-rectangle-in-histogram)
- [Maximal Rectangle](#-4-maximal-rectangle)
